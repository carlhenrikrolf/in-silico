...
#define ampasyn	*_ppvar[6]._pval
#define _p_ampasyn	_ppvar[6]._pval
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 9, 7);
 	...
 	ivoc_help("help ?1 ampa /home/hbpschool2016/Documents/NEURON_tutorial/modeldb-etoh/x86_64/ampasyn.mod\n");
...
static int _reset;
static char *modelname = "AMPA receptor as distributed mechanism with random synaptic dynamics";
