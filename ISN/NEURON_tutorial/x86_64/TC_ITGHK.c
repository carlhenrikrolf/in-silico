...
extern Memb_func* memb_func;
 ...
 "setdata_TC_iT", _hoc_setdata,
 "efun_TC_iT", _hoc_efun,
 "evaluate_fct_TC_iT", _hoc_evaluate_fct,
 "ghk_TC_iT", _hoc_ghk,
 "nongat_TC_iT", _hoc_nongat,
 0, 0
};
#define efun efun_TC_iT
#define ghk ghk_TC_iT
#define nongat nongat_TC_iT
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 17, 5);
 	...
 	ivoc_help("help ?1 TC_iT /home/hbpschool2016/Documents/python_tutorials/NEURON_tutorial/x86_64/TC_ITGHK.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   m_inf = 1.0 / ( 1.0 + exp ( - ( _lv + 53.0 ) / 6.2 ) ) ;
   h_inf = 1.0 / ( 1.0 + exp ( ( _lv + 75.0 ) / 4.0 ) ) ;
   tau_m = ( 6.12 + 1.0 / ( exp ( - ( _lv + 128.0 ) / 16.7 ) + exp ( ( _lv + 12.8 ) / 18.2 ) ) ) / phi_m ;
   if ( _lv < - 75.0 ) {
     tau_h = exp ( ( _lv + 461.0 ) / 66.6 ) / phi_h ;
     }
   else {
     tau_h = ( 28.0 + exp ( - ( _lv + 16.0 ) / 10.5 ) ) / phi_h ;
     }
    return 0; }
